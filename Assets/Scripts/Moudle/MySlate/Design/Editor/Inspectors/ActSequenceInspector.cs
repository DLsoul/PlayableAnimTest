...
namespace Slate
{
	[CustomEditor(typeof(ActSequence))]
	public class ActSequenceInspector : Editor
	{
		...
		private static ActSequence cutscene;
		...
		public override void OnInspectorGUI()
		{
			...
			{
				EditorGUILayout.HelpBox("To edit a ActSequence prefab please open it first.", MessageType.Info);
				return;
			}
			...
			{ //generic undo
				Undo.RegisterFullObjectHierarchyUndo(cutscene.groupsRoot.gameObject, "ActSequence Inspector");
				Undo.RecordObject(cutscene, "ActSequence Inspector");
				willDirty = true;
			}
		...
		void DoCutsceneInspector()
		{
			...
			GUILayout.Label(string.Format("<b>{0} ActSequence Settings</b>", optionsFold ? "▼" : "▶"));
