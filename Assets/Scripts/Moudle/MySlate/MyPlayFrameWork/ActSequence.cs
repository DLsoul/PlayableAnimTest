...
namespace Slate
{
    ...
    public class ActSequence : MonoBehaviour, IDirector
    {

        public const float VERSION_NUMBER = 2.15f;

        ///<summary>How the SkillSequence wraps</summary>
        ...
        ///<summary>What happens when SkillSequence stops</summary>
        ...
        ///<summary>Update modes for SkillSequence</summary>
        ...
        ///<summary>The direction the SkillSequence can play. An enum for clarity.</summary>
        ...
        ///<summary>Raised when any SkillSequence starts playing.</summary>
        public static event System.Action<ActSequence> OnCutsceneStarted;
        ///<summary>Raised when any SkillSequence stops playing.</summary>
        public static event System.Action<ActSequence> OnCutsceneStopped;

        ///<summary>Raised when a SkillSequence section has been reached.</summary>
        public event System.Action<Section> OnSectionReached;
        ///<summary>Raised when a global message has been send by this SkillSequence.</summary>
        public event System.Action<string, object> OnGlobalMessageSend;

        ///<summary>Raised when the SkillSequence is stopped. Important: Subscribers are cleared once the event is raised.</summary>
        public event System.Action OnStop;

        [SerializeField]
        [Tooltip("When is the SkillSequence updated.")]
        private UpdateMode _updateMode;
        [SerializeField]
        [Tooltip("How the SkillSequence wraps (relevant to runtime only)")]
        private WrapMode _defaultWrapMode;
        [SerializeField]
        [Tooltip("What will happen when the SkillSequence is stopped.")]
        private StopMode _defaultStopMode;
        [SerializeField]
        [Tooltip("The speed at which the SkillSequence is playing. Can be both positive or negative.")]
        private float _playbackSpeed = 1f;
        [SerializeField]
        [Tooltip("If enabled, the SkillSequence will start playing when enter play.")]
        private bool _playOnStart = false;
        [SerializeField]
        [Tooltip("If enabled, you can set only some layers to be active for the duration of this SkillSequence.")]
        ...
        [System.NonSerialized]
        private static Dictionary<string, ActSequence> allSceneCutscenes = new Dictionary<string, ActSequence>();
        [System.NonSerialized]
        ...
        ///<summary>When is the SkillSequence updated</summary>
        ...
        ///<summary>How the SkillSequence wraps when playing by default</summary>
        ...
        ///<summary>What will happen when the SkillSequence is stopped by default</summary>
        ...
        ///<summary>Will the SkillSequence start playing automatically?</summary>
        ...
        ///<summary>The layers that will be active when the SkillSequence is active. Everything else is disabled for the duration of the SkillSequence</summary>
        ...
        ///<summary>The single Director Group of the SkillSequence</summary>
        ...
        ///<summary>The single Camera Track of the SkillSequence</summary>
        ...
        ///<summary>The speed at which the SkillSequence is played back. Can be positive or negative. Not applicaple when Sampled manually without calling Play().</summary>
        ...
        ///<summary>The direction the SkillSequence is playing if at all. Can be changed while SkillSequence is playing.</summary>
        public PlayingDirection playingDirection { get; set; }
        ///<summary>The WrapMode the SkillSequence is currently using. Can be changed while SkillSequence is playing.</summary>
        public WrapMode playingWrapMode { get; set; }
        ///<summary>All directable elements within the SkillSequence</summary>
        public List<IDirectable> directables { get; private set; }
        ///<summary>Is SkillSequence playing? (Note: it can be paused and isActive still be true)</summary>
        public bool isActive { get; private set; }
        ///<summary>Is SkillSequence paused?</summary>
        ...
        ///<summary>Get all affected actors within the groups of the SkillSequence</summary>
        ...
        ///<summary>Start or resume playing the SkillSequence at optional start time and optional provided callback for when it stops</summary>
            ...
            )
        {
            ...
            { //if it's paused resume.
                Debug.LogWarning("Play called on a Paused SkillSequence. SkillSequence will now resume instead.", gameObject);
            ...
            if (isActive)
            {
                Debug.LogWarning("SkillSequence is already Running.", gameObject);
                return;
            }
        ...
        ///<summary>Stops the SkillSequence completely.</summary>
        ...
        ///<summary>Start or resume playing the SkillSequence at reverse, at optional new start time and optional provided callback for when it stops</summary>
        ...
        ///<summary>Pause the SkillSequence</summary>
        public void Pause() { isPaused = true; }
        ///<summary>Resume if SkillSequence was active</summary>
        public void Resume() { isPaused = false; }
        ///<summary>Skip the SkillSequence to the end</summary>
        public void SkipAll() { if (isActive) Stop(StopMode.Skip); else Sample(length); }
        ///<summary>Rewind the SkillSequence to it's initial 0 time state</summary>
        public void Rewind() { if (isActive) Stop(StopMode.Rewind); else Sample(0); }

        ///<summary>Rewinds the SkillSequence to it's initial 0 time state without undoing anything, thus keeping current state as finalized.</summary>
        ...
        ///<summary>Breaks out of the SkillSequence Loop (or PingPong) in case the SkillSequence was looping in the first place</summary>
        ...
        /////<summary>Skip the SkillSequence time to the next Section or end time if none.</summary>
        ...
        ///<summary>Set the SkillSequence time to a specific section by name</summary>
        ...
        ///<summary>Sample SkillSequence state at time specified (currentTime by default). You can call this however and whenever you like without any pre-requirements</summary>
        ...
        */
        ...
        ///<summary>Resamples SkillSequence. Useful when action settings have been changed</summary>
        ...
        //use of active layers to toggle root object on or off during SkillSequence
        ...
        ///<summary>Update the SkillSequence by delta</summary>
        ...
        ///<summary>Play a SkillSequence of specified name that exists either in the Resources folder or in the scene. In that order.</summary>
        public static ActSequence Play(string name) { return Play(name, null); }
        public static ActSequence Play(string name, System.Action callback)
        {
            var cutscene = FindFromResources(name);
            if (cutscene != null)
            {
                var instance = (ActSequence)Instantiate(cutscene);
                Debug.Log("Instantiating SkillSequence from Resources");
                instance.Play(() =>
                {
                    Destroy(instance.gameObject);
                    Debug.Log("Instantiated SkillSequence Destroyed");
                    if (callback != null)
                    {
                        callback();
                    }
        ...
        ///<summary>Find a SkillSequence from Resources folder</summary>
        public static ActSequence FindFromResources(string name)
        {
            var go = Resources.Load(name, typeof(GameObject)) as GameObject;
            if (go != null)
            {
                var cut = go.GetComponent<ActSequence>();
                if (cut != null)
                {
                    return cut;
                }
            }
            Debug.LogWarning(string.Format("SkillSequence of name '{0}' does not exists in the Resources folder", name));
            return null;
        }

        ///<summary>Find a SkillSequence of specified name that exists in the scene</summary>
        public static ActSequence Find(string name)
        {
            ActSequence cutscene = null;
            if (allSceneCutscenes.TryGetValue(name, out cutscene))
            {
                return cutscene;
            }
            Debug.LogError(string.Format("SkillSequence of name '{0}' does not exists in the scene", name));
            return null;
        }
        ...
        {
            foreach (var cutscene in FindObjectsOfType<ActSequence>())
            {
        ...
        ///<summary>Sends a message to all affected gameObject actors (including Director Camera), as well as the SkillSequence gameObject itself.</summary>
        ...
        public void SetGroupActorOfName(string groupName, GameObject newActor)
        {
            ...
            if (currentTime > 0)
            {
                Debug.LogError("Setting a Group Actor is only allowed when the SkillSequence is not active and is rewinded", gameObject);
                return;
            }
            ...
            if (group == null)
            {
                Debug.LogError(string.Format("Actor Group with name '{0}' doesn't exist in SkillSequence", groupName), gameObject);
                return;
            }
        ...
        public IDirectable FindElement(string path)
        {
            ...
            if (result == null)
            {
                Debug.LogWarning(string.Format("SkillSequence element path to '{0}', was not found", path));
            }
        ...
        {
            return string.Format("'{0}' SkillSequence", name);
        }
        ...
        ///<summary>By default SkillSequence is initialized when it starts playing. You can pre-initialize it if you want so for performance in case there is any lag when SkillSequence is started.</summary>
        ...
        ///<summary>Render the SkillSequence to an image sequence in runtime and get a Texture2D[] of the rendered frames. This operation will take several frames to complete. Use the callback parameter to get the result when rendering is done.</summary>
        public void RenderCutscene(int width, int height, int frameRate, System.Action<Texture2D[]> callback)
        {

            if (!Application.isPlaying)
            {
                Debug.LogError("Rendering SkillSequence with RenderCutscene function is only meant for runtime", this);
                return;
            }

            if (isActive)
            {
                Debug.LogWarning("You called RenderCutscene to an actively playing SkillSequence. The SkillSequence will now Stop.", this);
                Stop();
            }
        ...
        void RemoveComponent() { Debug.LogWarning("Removing the SkillSequence Component is not possible. Please delete the GameObject instead"); }
        ...
        public static ActSequence Create(Transform parent = null)
        {
            var cutscene = new GameObject("SkillSequence").AddComponent<ActSequence>();
            if (parent != null)
            {
        ...
        ///<summary>Add a group to the SkillSequence.</summary>
        ...
        public CutsceneGroup AddGroup(System.Type type, GameObject targetActor = null)
        {
            ...
            //{
            //    Debug.LogWarning("A SkillSequence can only contain one Director Group", this);
        ...
        ///<summary>Duplicate a group in the SkillSequence.</summary>
        ...
        ///<summary>Delete a group from the SkillSequence.</summary>
        public void DeleteGroup(CutsceneGroup group)
        {
            ...
            //{
            //    Debug.LogWarning("The Director Group can't be removed from the SkillSequence", gameObject);
            //    return;
            //}
